...
En una de las notas hay unas credenciales ``tyler / 92g!mA8BGjOirkL%OG*&``, con crackmapexce compuebo las credenciales .
...
Despues de conectarme por RDP a la maquina como ``administrador`` habilito el winrm para tener acceso por ``evil-winrm`` y asi tener una persistencia.
